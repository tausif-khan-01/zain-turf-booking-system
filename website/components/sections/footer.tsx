        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href={config.turf.social.facebook}
              ...
              <a
                href={config.turf.social.twitter}
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary transition-colors"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                href={config.turf.social.instagram}
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary transition-colors"
              >
                <svg
                  className="w-5 h-5"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">{config.turf.address}</span>
              </li>
              <li className="flex items-center">
                <PhoneIcon className="w-5 h-5 text-primary mr-3 flex-shrink-0" />
                <span className="text-gray-400">{config.turf.phone}</span>
              </li>
              <li className="flex items-center">
                <svg
                ...
                <span className="text-gray-400">{config.turf.email}</span>
              </li>
            </ul>
          </div>
